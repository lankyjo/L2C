    ...
    <div className="px-3">
      <div className=" border border-black md:max-w-[80%] md:mx-auto mt-10">
        ...
        <div className="p-5 px-10 py-10">
          ...
          <p className="mb-6"> Hello, I’m <strong>LankyJo</strong>—a passionate web developer, creative problem solver, and lifelong learner. My journey in technology began at a young age when I first discovered the magic of coding. I was fascinated by how a few lines of code could transform ideas into interactive experiences, and that curiosity has driven me ever since. </p> <p className="mb-6"> Over the years, I have immersed myself in web development, mastering **HTML, CSS, and JavaScript**, and diving into frameworks like **React and Next.js**. I love creating digital experiences that are not just visually stunning but also fast, responsive, and user-friendly. Whether it's refining UI interactions, optimizing performance, or exploring new design techniques, I thrive on building solutions that leave an impact. </p> <p className="mb-6"> While my focus is on frontend development, I’m also expanding my skills into **backend technologies like Node.js, MongoDB, and Python**. I’m currently learning how to build full-stack applications, and I enjoy solving real-world problems through **AI** and automation. </p> <p className="mb-6"> Beyond development, I have a growing interest in **penetration testing** and ethical hacking. Security has always intrigued me, and I aspire to become a **penetration tester**—someone who can identify vulnerabilities and help make digital systems safer. This journey is still unfolding, but I’m excited to explore more about **offensive security, ethical hacking, and network defense** as I continue learning. </p> <p className="mb-6"> When I’m not coding, I find inspiration in art, music, and deep conversations. I also enjoy pushing the boundaries of what’s possible with **Web3** and emerging technologies. This blog is my creative outlet—a space where I share my projects, insights, and lessons learned along the way. </p> <p> Thank you for stopping by! Whether you're a fellow developer, security enthusiast, or just someone curious about tech, I’d love to connect and grow together. 🚀 </p>
        </div>
      </div>
      <Emailform />
    </div>
